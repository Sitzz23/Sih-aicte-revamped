	...
	return (
		<div className="overflow-x-hidden mt-12">
			...
			<div className="relative w-screen">
				<img src={pie} alt="pie graph" width="50%" className="mx-auto " />
				<img
					src={bulb}
					alt="bulb"
					width="70px"
				...
				<div className="absolute top-[110px] right-[10px] -translate-x-1/2 -translate-y-1/2">
					<h1 className="font-semibold text-xl">3. National e-Scholarship</h1>
					<p className="w-80 pt-4">
						National e-Scholarship is the one-stop solution to help students
						seek various scholarships.
					</p>
				...
				<div className="absolute top-[550px] -right-[40px] -translate-x-1/2 -translate-y-1/2">
					<h1 className="font-semibold text-xl">4. National e-Scholarship</h1>
					<p className="w-80 pt-4">
						National e-Scholarship is the one-stop solution to help students
						seek various scholarships.
					</p>
				...
				<div className="absolute top-[670px] left-[420px] -translate-x-1/2 -translate-y-1/2">
					<h1 className="font-semibold text-xl">2. National e-Scholarship</h1>
					<p className="w-80 pt-4">
						National e-Scholarship is the one-stop solution to help students
						seek various scholarships.
					</p>
				...
				<div className="absolute top-[300px] left-[300px] -translate-x-1/2 -translate-y-1/2">
					<h1 className="font-semibold text-xl">1. National e-Scholarship</h1>
					<p className="w-80 pt-4">
						National e-Scholarship is the one-stop solution to help students
						seek various scholarships.
					</p>
